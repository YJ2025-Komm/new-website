...
const mainPages = [
  ...
  { url: `${baseUrl}/features/prompt-intelligence`, priority: "0.8", changefreq: "monthly" },
  { url: `${baseUrl}/features/ai-recommendations`, priority: "0.8", changefreq: "monthly" },
  { url: `${baseUrl}/features/content-hub`, priority: "0.8", changefreq: "monthly" },
  { url: `${baseUrl}/features/geo-agent`, priority: "0.8", changefreq: "monthly" },
  { url: `${baseUrl}/features/country-specific-ai-tracking`, priority: "0.8", changefreq: "monthly" },
  ...
  { url: `${baseUrl}/alternatives/peec-ai`, priority: "0.6", changefreq: "monthly" },
  { url: `${baseUrl}/alternatives/profound`, priority: "0.6", changefreq: "monthly" },
  { url: `${baseUrl}/alternatives/scrunch-ai`, priority: "0.6", changefreq: "monthly" },
