...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen text-slate-900 overflow-x-hidden">
      ...
      {/* Hero + Pricing Cards — shared floating icon canvas */}
      <div className="relative" style={{ overflowX: 'clip' }}>

        {/* Floating AI icons spanning hero + cards */}
        <div className="hidden sm:block absolute inset-0 z-20 pointer-events-none" aria-hidden="true">
          {/* Top row — hero area */}
          <div className="absolute top-[6%] left-[1%] sm:left-[2%] animate-logo-drift" style={{ animationDelay: '0s' }}>
          ...
          <div className="absolute top-[6%] right-[1%] sm:right-[2%] animate-logo-drift" style={{ animationDelay: '1s' }}>
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl bg-white/80 backdrop-blur-sm shadow-lg flex items-center justify-center">
              <SiGooglegemini className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-blue-500" />
            </div>
          </div>
          {/* Mid row — transition into cards */}
          <div className="absolute top-[38%] left-[1%] sm:left-[2%] animate-logo-drift" style={{ animationDelay: '2s' }}>
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl bg-white/80 backdrop-blur-sm shadow-lg flex items-center justify-center">
              <SiPerplexity className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-slate-700" />
            </div>
          </div>
          <div className="absolute top-[38%] right-[1%] sm:right-[2%] animate-logo-drift" style={{ animationDelay: '3s' }}>
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl bg-white/80 backdrop-blur-sm shadow-lg flex items-center justify-center">
              <SiClaude className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-orange-500" />
            </div>
          </div>
          {/* Bottom row — lower cards area */}
          <div className="absolute bottom-[6%] left-[1%] sm:left-[2%] animate-logo-drift" style={{ animationDelay: '4s' }}>
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl bg-white/80 backdrop-blur-sm shadow-lg flex items-center justify-center">
      ...
      </div>{/* end shared floating icon canvas */}
