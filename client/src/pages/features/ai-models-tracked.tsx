...
import { ArrowUp, Check, Rocket } from "lucide-react";
...
export default function AiModelsTracked() {
  ...
  useBreadcrumbSchema("ai-models-tracked-breadcrumb-schema", [
    ...FEATURES_CRUMBS,
    { name: "AI Models Tracked", item: "https://georankers.ai/features/ai-models-tracked" },
  ]);
  ...
  return (
    <div className="min-h-screen text-slate-900" style={{ overflowX: "clip" }}>
      ...
      <main id="main-content">
        ...
        <FAQSection
          faqs={FAQS}
          schemaId="ai-models-tracked-faq-schema"
          footer={
            <>
