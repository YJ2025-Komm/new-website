...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-slate-900 overflow-x-hidden">
      ...
      {/* Footer */}
      <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-16 sm:py-20 overflow-hidden">
        {/* Background accents */}
        <div className="absolute bottom-0 left-1/4 w-72 h-72 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-full blur-3xl"></div>
        <div className="absolute top-0 right-1/4 w-56 h-56 bg-gradient-to-r from-violet-500/10 to-pink-500/10 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-32 bg-gradient-to-r from-blue-500/5 to-violet-500/5 rounded-full blur-3xl"></div>
        
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center space-y-10">
            {/* Trust Line */}
            <p className="text-xl sm:text-2xl font-medium text-white/90 whitespace-nowrap">
              Built for B2B SaaS teams exploring <span className="bg-gradient-to-r from-blue-400 to-violet-400 bg-clip-text text-transparent">AI search visibility</span>.
            </p>
            ...
            <div className="space-y-3">
              ...
              <a 
                ...
                className="inline-flex items-center text-slate-300 hover:text-blue-400 transition-all duration-300 text-base font-medium group"
                data-testid="link-footer-email"
              >
                <Mail className="w-4 h-4 mr-2 text-slate-500 group-hover:text-blue-400 transition-colors" />
                hello@georankers.co
              </a>
            </div>
